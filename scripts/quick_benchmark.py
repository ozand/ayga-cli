#!/usr/bin/env python3
"""Quick benchmark for A-Parser CLI utility features."""
...
from aparser_cli.manifest import Manifest, ParserInfo, FuzzySearchIndex
...
def main():
    print("=" * 60)
    print("A-Parser CLI Quick Benchmark")
    print("=" * 60)
