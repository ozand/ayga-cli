"""Enhanced MCP server for A-Parser CLI integration.
...
async def list_tools() -> list[Tool]:
    """List available A-Parser MCP tools."""
    return [
        Tool(
            name="search_parsers",
            description="""
...
async def _search_parsers(
    ...
    try:
        ...
        if not manifest:
            return {
                "success": False,
                "error": "No manifest found. Run 'aparser parsers sync' first.",
                "results": [],
            }
