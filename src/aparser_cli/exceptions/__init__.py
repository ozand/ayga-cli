"""A-Parser CLI custom exceptions."""

from typing import Optional


class AParserError(Exception):
    """Base exception for all A-Parser CLI errors."""
    pass


class AParserConfigError(AParserError):
    """Configuration-related errors."""
    pass


class AParserHTTPError(AParserError):
    """HTTP API errors.
...
class AParserAPIError(AParserError):
    """A-Parser API returned an error response.
    ...
    def get_formatted_error(self, verbose: bool = False) -> str:
        ...
        """
        from aparser_cli.utils.error_helper import format_error_for_cli
        return format_error_for_cli(self.error_info, verbose=verbose)


class AParserAuthError(AParserError):
    """Authentication/authorization errors."""
    pass


class AParserRedisError(AParserError):
...
class AParserValidationError(AParserError):
    """Input validation errors."""
    pass


class AParserProxyError(AParserAPIError):
...
class AParserServerError(AParserAPIError):
