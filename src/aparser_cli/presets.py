"""Presets management for A-Parser CLI.

Provides a system for saving and loading parser presets with override configurations.
Presets are stored in ~/.config/aparser-cli/presets.json
"""
...
class Preset:
    ...
    def build_options(self) -> list[dict[str, Any]]:
        """Convert overrides to A-Parser options format.
...
class PresetManager:
    ...
    Presets are stored in JSON format at ~/.config/aparser-cli/presets.json
