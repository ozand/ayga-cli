"""Error parsing and recommendations for A-Parser API errors."""
...
ERROR_PATTERNS = {
    ...
    "500 Internal Server Error": {
        ...
        "docs_link": "https://a-parser.com/docs",
    },
    "timeout": {
        "message": "Request timed out",
        "recommendation": "Increase timeout override",
        "example": 'aparser run ... --overrides "timeout=180"',
    },
    "Timeout": {
        "message": "Request timed out",
        "recommendation": "Increase timeout override",
    ...
    "Unauthorized": {
        ...
        "recommendation": "Check your A-Parser password configuration",
        "example": "aparser config set password YOUR_PASSWORD",
    },
    "Invalid parser": {
        "message": "Parser not found or invalid",
        "recommendation": "Check parser name or use 'aparser parsers list-static' to see available parsers",
        "example": "aparser parsers info FreeAI::Perplexity",
    },
    "rate limit": {
...
PARSER_DOCS = {
    "FreeAI::Perplexity": "https://a-parser.com/docs/parsers/freeai-perplexity",
    "FreeAI::ChatGPT": "https://a-parser.com/docs/parsers/freeai-chatgpt",
    "SE::Google": "https://a-parser.com/docs/parsers/se-google",
    "SE::Yandex": "https://a-parser.com/docs/parsers/se-yandex",
    "Net::Whois": "https://a-parser.com/docs/parsers/net-whois",
}
...
def parse_api_error(response_data: dict, parser_name: Optional[str] = None) -> dict:
    ...
    if not result["docs_link"]:
        result["docs_link"] = "https://a-parser.com/docs"
